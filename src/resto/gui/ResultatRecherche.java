 ...
 * @author dell
 */
public class ResultatRecherche extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        AjouterClientLabel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Restaurant(s) trouvé(s)", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Century Gothic", 0, 11))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ResultatRecherche.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ResultatRecherche().setVisible(true);
            }
        });
    }
